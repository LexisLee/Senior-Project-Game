...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			hand = GameObject.Find ("Hit");
			hitEnemy = (Attacking)hand.GetComponent(typeof(Attacking));
        }
        ...
        private void FixedUpdate()
        {
            ...
            player.movePlayer(m_Move, m_crouch, m_Jump, m_attack);
			hitEnemy.SwungAtEnemy (m_attack);
            m_Jump = false;
			m_attack = false;
        }
    }
